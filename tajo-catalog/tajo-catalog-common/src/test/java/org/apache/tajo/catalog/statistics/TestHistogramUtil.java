...
////      histogram.addBucket(new FreqBucket(new TupleRange(current.getFirst(), next.getFirst(),
////          histogram.getComparator()), current.getSecond()));
//    }
//    if (next != null) {
////      histogram.addBucket(new FreqBucket(new TupleRange(next.getFirst(), next.getFirst(),
