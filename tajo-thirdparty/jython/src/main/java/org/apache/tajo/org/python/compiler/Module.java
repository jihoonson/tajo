...
import org.apache.tajo.org.python.antlr.ast.Suite;
...
import static org.apache.tajo.org.python.util.CodegenUtils.*;
...
class PyCodeConstant extends Constant implements ClassConstants, Opcodes {
    ...
    PyCodeConstant(mod tree, String name, boolean fast_locals, String className, boolean classBody,
        ...
        if (CodeCompiler.checkOptimizeGlobals(fast_locals, scope)) {
            _moreflags |= org.apache.tajo.org.python.core.CodeFlag.CO_OPTIMIZED.flag;
        }
        if (scope.generator) {
            _moreflags |= org.apache.tajo.org.python.core.CodeFlag.CO_GENERATOR.flag;
        }
        if (cflags != null) {
            if (cflags.isFlagSet(CodeFlag.CO_GENERATOR_ALLOWED)) {
                _moreflags |= org.apache.tajo.org.python.core.CodeFlag.CO_GENERATOR_ALLOWED.flag;
            }
            if (cflags.isFlagSet(CodeFlag.CO_FUTURE_DIVISION)) {
                _moreflags |= org.apache.tajo.org.python.core.CodeFlag.CO_FUTURE_DIVISION.flag;
            }
        }
...
public class Module implements Opcodes, ClassConstants, CompilationContext {
    ...
    public Module(String name, String filename, boolean linenumbers) {
        this(name, filename, linenumbers, org.apache.tajo.org.python.core.imp.NO_MTIME);
    }
    ...
    public Module(String name) {
        this(name, name + ".py", true, org.apache.tajo.org.python.core.imp.NO_MTIME);
    }
    ...
    public static void compile(mod node, OutputStream ostream, String name, String filename,
        ...
        compile(node, ostream, name, filename, linenumbers, printResults, cflags,
            org.apache.tajo.org.python.core.imp.NO_MTIME);
    }
