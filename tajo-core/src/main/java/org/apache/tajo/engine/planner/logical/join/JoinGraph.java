...
//            joinNode.getLeftChild(), joinNode.getRightChild(), joinNode.getJoinQual());
          plan.getLeftChild(joinNode), plan.getRightChild(joinNode), joinNode.getJoinQual());

      SortedSet<String> leftNodeRelationName =
          new TreeSet<String>(PlannerUtil.getRelationLineageWithinQueryBlock(plan, plan.getLeftChild(joinNode)));
      SortedSet<String> rightNodeRelationName =
          new TreeSet<String>(PlannerUtil.getRelationLineageWithinQueryBlock(plan, plan.getRightChild(joinNode)));
